...
function startBtnEvent(playerOneBoard: any, playerTwoBoard: any) {
...
function doneBtnEvent(playerOneBoard: any) {
...
function createBoard(playerOneBoard: any, playerTwoBoard: any) {
  for (let i = 0; i < 100; i++) {
...
function displayShips(board: any[], playerCellArray: any[]) {
  for (let i = 0; i < 10; i++) {
    for (let j = 0; j < 10; j++) {
